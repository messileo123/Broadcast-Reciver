...
class MainActivity : AppCompatActivity() {
    private val airplanmodeReciver= AirplanmodeReciver()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerReceiver(airplanmodeReciver, IntentFilter(Intent.ACTION_AIRPLANE_MODE_CHANGED))
    ...
    override fun onDestroy() {
       ...
       unregisterReceiver(airplanmodeReciver)
